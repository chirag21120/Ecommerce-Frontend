    ...
    <>
      <div className="flex flex-1 justify-between sm:hidden">
        <button
          ...
          className={`relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 ${page!==1?`hover:bg-gray-50`:''}`}
        ...
        <button
          onClick={e=>handlePage(page+1)}
          className={`relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 ${page!==totalPages?`hover:bg-gray-50`:''}`}
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            <button
              onClick={e=>handlePage(page-1)}
              className={`relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 ${page!==totalPages?`hover:bg-gray-50`:''} focus:z-20 focus:outline-offset-0`}
              disabled={page===1?true:false}
            >
            ...
            <button
              onClick={e=>handlePage(page+1)}
              className={`relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 ${page!==totalPages?`hover:bg-gray-50`:''} focus:z-20 focus:outline-offset-0`}
